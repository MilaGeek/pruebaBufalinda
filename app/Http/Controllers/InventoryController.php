...
//dd($inbound_order_all);
    ...
    public function transfer()
    {
        ...
        return view('layouts.inventory.transfer', compact('inven_item', 'inventory', 'inbound_order', 'wareh', 'inv_loc', 'item', 'collection', 'wareh_sin_airpot', 'pallet', 'warehouse_bodega', 'valores', 'document'));
    }
