                                                ...
                                                <form action="{{ url('/master/warehouse/'. $item->id_warehouse.'/update') }} " method="post" >
                                                    ...
                                                    <div class="row form-horizontal">
                                                        ...
                                                        <div class="col-md-10" style="margin-top: -20px;">
                                                            <div class="checkbox checkbox-inline">
                                                                <label>
                                                                    <input type="checkbox" name="optionsCheckboxes[]" value="Sale" @if($item->house_activity=="Sale") checked @endif>Sale
                                                                </label>
                                                            </div>
                                                       
                                                            <div class="checkbox checkbox-inline">
                                                                <label>
                                                                    <input type="checkbox" name="optionsCheckboxes[]" value="Transfer" @if($item->house_activity=="Transfer") checked @endif>Transfer
                                                                </label>
                                                            </div>
                                                            <div class="checkbox checkbox-inline">
                                                                <label>
                                                                    <input type="checkbox" name="optionsCheckboxes[]" value="Entry" @if($item->house_activity=="Entry") checked @endif>Entry
                                                                </label>
                                                            </div>
                                                            <div class="checkbox checkbox-inline">
                                                                <label>
                                                                    <input type="checkbox" name="optionsCheckboxes[]"value="Output" @if($item->house_activity=="Output") checked @endif>Output
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
